...
class MY_Model extends CI_Model
{
    ...
    {
		return $this->get($this->primary_key, $primary_value);
    }
    ...
    public function relate($row)
    {
        ...
        foreach ($this->belongs_to as $key => $value)
        {
            if (is_string($value))
            {
                ...
                $options = array( 'primary_key' => $value . '_id', 'model' => $value );
            }
            else
            {
                $relationship = $key;
        ...
        foreach ($this->has_many as $key => $value)
        {
            if (is_string($value))
            {
                ...
                $options = array( 'primary_key' => singular($this->_table) . '_id', 'model' => singular($value) );
            }
            else
            {
                $relationship = $key;
